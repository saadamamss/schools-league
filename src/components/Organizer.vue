                ...
                <v-list density="compact">
                  <v-list-item>
                    ...
                    <template v-slot:append>
                      <v-icon v-if="user.email_verified" color="success"
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    <v-list-item>
                      ...
                      <v-list-item-title
                        >تاريخ التحقق من البريد</v-list-item-title
                      >
                      <v-list-item-subtitle class="text-right">
                        {{
                  ...
                  <v-col cols="12" md="6">
                    <v-list-item>
                      ...
                      <v-list-item-subtitle class="text-right"
                        >{{ user.working_days_count }} يوم</v-list-item-subtitle
                      >
                    </v-list-item>
                  </v-col>
                  ...
                  <v-col cols="12" md="6">
                    <v-list-item>
                      ...
                      <v-list-item-subtitle class="text-right"
                        >{{ user.daily_rate }} ر.س</v-list-item-subtitle
                      >
                    </v-list-item>
                  </v-col>
                  ...
                  <v-col cols="12" md="6">
                    <v-list-item>
                      ...
                      <v-list-item-title
                        >فصل من الأحداث اليومية</v-list-item-title
                      >
                      <v-list-item-subtitle class="text-right">
                ...
                <v-row>
                  <v-col cols="12" md="6">
                    <v-list-item>
                      ...
                      <v-list-item-subtitle class="text-right">
                        {{
                          user.today_check_in
                            ? formatDateTime(user.today_check_in)
                            : "لم يسجل دخول"
                        }}
                      </v-list-item-subtitle>
                    </v-list-item>
                  ...
                  <v-col cols="12" md="6">
                    <v-list-item>
                      ...
                      <v-list-item-subtitle class="text-right">
                        {{
                          user.today_check_out
                            ? formatDateTime(user.today_check_out)
                            : "لم يسجل خروج"
                        }}
                      </v-list-item-subtitle>
                    </v-list-item>
                  ...
                  <v-col cols="12">
                    <v-list-item>
                      <template v-slot:prepend>
                        <v-icon
                          :color="getStatusColor(user.today_attendance_status)"
                        >
                          {{ getStatusIcon(user.today_attendance_status) }}
                        </v-icon>
                      </template>
                      <v-list-item-title>حالة الحضور</v-list-item-title>
                      <v-list-item-subtitle class="text-right">
                        {{ getStatusText(user.today_attendance_status) }}
                      </v-list-item-subtitle>
                    </v-list-item>
                  </v-col>
                </v-row>
