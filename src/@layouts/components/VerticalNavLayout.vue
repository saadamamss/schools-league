    ...
    return () => {
      ...
      const navbar = h(
        ...
        [
          h(
            "div",
            { class: "navbar-content-container rounded-0" },
            slots.navbar?.({
      ...
      return h(
        ...
        [
          verticalNavWrapper
            ...
            : verticalNav,
          h("div", { class: "layout-content-wrapper" }, [navbar, main]), // [navbar, main, footer]
          layoutOverlay,
        ]
      );
    };
...
.v-theme--light .layout-vertical-nav .nav-link > :not(.router-link-exact-active):first-child,
.v-theme--light .layout-vertical-nav .nav-group > :not(.router-link-exact-active):first-child {
