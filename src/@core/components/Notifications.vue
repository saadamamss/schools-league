...
<template>
  <VBtn class="btn-icon" color="background" elevation="0" height="48">
    <VBadge
      color="primary"
      content="3"
    ...
    >
      <VList class="py-0 text-dark">
        <!-- 👉 Header -->
        <VListItem class="notification-section" height="48px" title="التنبيهات">
          <!-- <template #append>
        ...
        <VListItem class="notification-section">
          <VBtn block color="dark" variant="text"> عرض جميع التنبيهات </VBtn>
        </VListItem>
      </VList>
    </VMenu>
  </VBtn>
