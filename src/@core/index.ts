...
interface VerticalNavConfig {
  isVerticalNavCollapsed: boolean
  defaultNavItemIconProps?: Record<string, unknown>
  isVerticalNavSemiDark: boolean
}

interface HorizontalNavConfig {
  type: string
  transition: string
}
...
interface UserConfig {
  ...
  navbar: NavbarConfig
  footer: FooterConfig
  verticalNav: VerticalNavConfig
  horizontalNav: HorizontalNavConfig
  icons: IconsConfig
}

export const defineThemeConfig = (userConfig: UserConfig) => {
